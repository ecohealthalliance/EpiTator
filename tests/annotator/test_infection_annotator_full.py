    ...
    def test_hospitalization_counts1(self):
        ...
        for example, actual_count in examples:
            ...
            test_utils.assertHasProps(
                doc.tiers['infections'].spans[0].metadata, {
                    'count': actual_count,
                    'attributes': ['infection', 'hospitalization']
                })
...
Ongoing cases: 7
""", [
            {'count': 15, 'attributes': ['infection', 'confirmed']},
            {'count': 2, 'attributes': ['infection', 'death']},
            {'count': 5, 'attributes': ['infection', 'hospitalization']},
            {'count': 7, 'attributes': ['infection', 'ongoing']}])
    ...
    def test_complex(self):
        ...
        counts = [
            {'count': 2, 'attributes': ['infection', 'incremental']},
...
"""
    ...
    def test_space_delimited_counts(self):
        self.assertHasCounts('There were 197 000 deaths in 2007.',
                             [{'count': 197000, 'attributes': ['infection', 'death']}])
    ...
    #     ''')
    #     doc.add_tier(self.annotator)
    #     self.assertEqual(len(doc.tiers['infections']), 10)
