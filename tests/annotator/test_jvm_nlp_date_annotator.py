...
class JVMNLPAnnotatorTest(unittest.TestCase):
    ...
    def test_simple_date(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].label, '2010-10-07')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, 'Friday, October 7th 2010')
    ...
    def test_relative_date(self):
        ...
        self.assertEqual(len(doc.tiers['stanford.times'].spans), 1)
        self.assertEqual(doc.tiers['stanford.times'].spans[0].label, '2010-10-11')
    ...
    def test_relative_dates(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[1].label, '2010-10-15')
        self.assertEqual(doc.tiers['stanford.times'].spans[1].text, 'five days from now')
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[2].label, '2010-10-09')
        self.assertEqual(doc.tiers['stanford.times'].spans[2].text, 'yesterday')
    ...
    def test_season(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, 'Last summer')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].start, 0)
    ...
    def test_extracted_reference_date(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].label, '2014-10-10')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, '10/10/14')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].start, 0)
        self.assertEqual(doc.tiers['stanford.times'].spans[0].end, 8)
        self.assertEqual(doc.tiers['stanford.times'].spans[0].type, 'DATE')

        self.assertEqual(doc.tiers['stanford.times'].spans[1].label, '2014-10-09T11:00')
        self.assertEqual(doc.tiers['stanford.times'].spans[1].text, '11am yesterday')
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[2].label, '2014-10-11')
    ...
    def test_time(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[1].label, '2014-10-10T15:00')
        self.assertEqual(doc.tiers['stanford.times'].spans[1].text, '3 in the afternoon')
        self.assertEqual(doc.tiers['stanford.times'].spans[1].start, 22)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].end, 40)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].type, 'TIME')
        self.assertEqual(doc.tiers['stanford.times'].spans[1].timePoint.year, 2014)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].timePoint.month, 10)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].timePoint.date, 10)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].timePoint.hour, 15)
    ...
    def test_duration(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, 'three years')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].start, 18)
    ...
    def test_duration_with_years(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].end, 29)
        self.assertEqual(doc.tiers['stanford.times'].spans[0].type, 'DURATION')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].timeDuration.label, 'P3Y')
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[1].end, 40)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].type, 'DATE')
        self.assertEqual(doc.tiers['stanford.times'].spans[1].timeRange.begin.year, 1999)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].timeRange.begin.month, 1)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].timeRange.begin.date, 1)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].timeRange.end.year, 1999)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].timeRange.end.month, 12)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].timeRange.end.date, 31)

        self.assertEqual(doc.tiers['stanford.times'].spans[2].label, '2001')
        self.assertEqual(doc.tiers['stanford.times'].spans[2].text, 'late 2001')
        self.assertEqual(doc.tiers['stanford.times'].spans[2].start, 47)
        self.assertEqual(doc.tiers['stanford.times'].spans[2].end, 56)
        self.assertEqual(doc.tiers['stanford.times'].spans[2].type, 'DATE')
        self.assertEqual(doc.tiers['stanford.times'].spans[2].timeRange.mod, 'LATE')
        self.assertEqual(doc.tiers['stanford.times'].spans[2].timeRange.end.mod, None)
        self.assertEqual(doc.tiers['stanford.times'].spans[2].timeRange.begin.year, 2001)
        self.assertEqual(doc.tiers['stanford.times'].spans[2].timeRange.begin.month, 1)
        self.assertEqual(doc.tiers['stanford.times'].spans[2].timeRange.begin.date, 1)
        self.assertEqual(doc.tiers['stanford.times'].spans[2].timeRange.end.year, 2001)
        self.assertEqual(doc.tiers['stanford.times'].spans[2].timeRange.end.month, 12)
        self.assertEqual(doc.tiers['stanford.times'].spans[2].timeRange.end.date, 31)
    ...
    def test_modifier_late(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[1].text, 'the end of the 1920s')
        self.assertEqual(doc.tiers['stanford.times'].spans[1].start, 26)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].end, 46)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].type, 'DATE')
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[1], 'timePoint'), False)
        self.assertEqual(doc.tiers['stanford.times'].spans[1].timeRange.mod, 'LATE')
    ...
    def test_modifier_less_than(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].label, 'P3Y')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, 'less than three years')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].start, 18)
        self.assertEqual(doc.tiers['stanford.times'].spans[0].end, 39)
        self.assertEqual(doc.tiers['stanford.times'].spans[0].type, 'DURATION')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].timeDuration.mod, 'LESS_THAN')
    ...
    def test_set(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].label, 'XXXX-WXX-2')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, 'every Tuesday')
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].timeSet.mod, None)
    ...
    def test_first_since(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].label, '2014 INTERSECT P3M')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, 'three months of 2014')
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timePoint'), False)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeRange'), False)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeDuration'), False)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeSet'), False)
    ...
    def test_previously(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].label, 'PAST_REF')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, 'previously')
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timePoint'), False)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeRange'), False)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeDuration'), False)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeSet'), False)
    ...
    def test_future(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].label, 'FUTURE_REF')
    ...
    def test_inexact_range(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].label, 'XXXX-05/2009-08')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, 'From May to August of 2009')
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timePoint'), False)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeRange'), True)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeDuration'), True)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeSet'), False)
    ...
    def test_1950s(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, 'the 1950s')
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timePoint'), False)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeRange'), True)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeDuration'), False)
        self.assertEqual(hasattr(doc.tiers['stanford.times'].spans[0], 'timeSet'), False)
    ...
    def test_intersect(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].label, '2015-01-01')
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, 'yesterday, 1 Jan 2015')
    ...
    def test_specificity(self):
        ...
        self.assertEqual(doc.tiers['stanford.times'].spans[0].text, 'November [2014')
